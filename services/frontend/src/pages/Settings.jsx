...
import { User, Shield, Mail, Key, Save, AlertTriangle, Eye, EyeOff } from 'lucide-react';
import api from '../api';
...
function Settings() {
    ...
    // Состояния для показа пароля (Глазики)
    ...
    // Стили для инпутов с паролем (чтобы код был чистым)
                ...
                <div className="w-full md:w-64 shrink-0">
                    <nav className="flex md:flex-col gap-2 overflow-x-auto pb-4 md:pb-0">
                        ...
                        <button
                            ...
                            className={`flex items-center gap-3 px-4 py-3 rounded-xl font-bold transition-all whitespace-nowrap ${
                                activeTab === 'security' ? 'bg-blue-50 text-blue-700' : 'text-slate-600 hover:bg-slate-50 hover:text-slate-900'
                            }`}
                        >
                                        ...
                                        <div className="mb-8 bg-amber-50 border border-amber-200 rounded-2xl p-5 flex gap-4 items-start">
                                            ...
                                            <div>
                                                ...
                                                <p className="text-amber-700 text-sm mt-1">
                                                    Вы вошли через Telegram. Пожалуйста, измените временный email на ваш настоящий для восстановления доступа.
                                                </p>
                                            </div>
                                        </div>
                                    )}
                                        ...
                                        <div>
                                            ...
                                            <div className="relative">
                                                <input 
                                                    ...
                                                    placeholder="••••••••"
                                                />
                                                <button type="button" onClick={() => setShowOld(!showOld)} className={eyeBtnClasses}>
                                        ...
                                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                                            <div>
                                                ...
                                                <div className="relative">
                                                    ...
                                                    />
                                                    <button type="button" onClick={() => setShowNew(!showNew)} className={eyeBtnClasses}>
                                            ...
                                            <div>
                                                ...
                                                <div className="relative">
                                                    ...
                                                    />
                                                    <button type="button" onClick={() => setShowConfirm(!showConfirm)} className={eyeBtnClasses}>
